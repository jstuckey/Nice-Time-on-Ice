...
class GamePresenterTest < ActiveSupport::TestCase
  ...
  test "#links should return list of anchor tags for each game in season" do
    expected = [%Q(<a class="game" href="/?game=2014021217&game_order=desc&game_type=2&season=2014&team=WSH">New York Rangers at</br>Washington Capitals</a>),
                %Q(<a class="game" href="/?game=2014021201&game_order=desc&game_type=2&season=2014&team=WSH">Boston Bruins at</br>Washington Capitals</a>)]
  ...
  test "#links should return ascending list of anchor tags if order passed in" do
    expected = [%Q(<a class="game" href="/?game=2014021201&game_order=asc&game_type=2&season=2014&team=WSH">Boston Bruins at</br>Washington Capitals</a>),
                %Q(<a class="game" href="/?game=2014021217&game_order=asc&game_type=2&season=2014&team=WSH">New York Rangers at</br>Washington Capitals</a>)]
