...
class SeasonPresenterTest < ActiveSupport::TestCase
  ...
  test "#links should return list of anchor tags for each season and postseason" do
    expected = [
      %(<a class="season" href="/?game_order=desc&game_type=2) +
        %(&season=2014&team=WSH">2014 - 2015</a>),
      %(<a class="season" href="/?game_order=desc&game_type=3) +
        %(&season=2014&team=WSH">2014 - 2015 Playoffs</a>),
      %(<a class="season" href="/?game_order=desc&game_type=2) +
        %(&season=2013&team=WSH">2013 - 2014</a>),
      %(<a class="season" href="/?game_order=desc&game_type=3) +
        %(&season=2013&team=WSH">2013 - 2014 Playoffs</a>)
    ]
